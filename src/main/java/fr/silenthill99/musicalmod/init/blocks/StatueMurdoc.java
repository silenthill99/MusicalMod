...
public class StatueMurdoc extends Block {
    ...
    public static final VoxelShape SHAPE_N = Stream.of(
            ...
            Block.box(12, 11.5, 6, 15, 23.5, 10),
            Block.box(1, 11.5, 6, 4, 23.5, 10),
            Block.box(4, -0.5, 6, 8, 11.5, 10),
            Block.box(8, -0.5, 6, 12, 11.5, 10),
            Block.box(3.5, 23, 3.5, 12.5, 32, 12.5),
            Block.box(4, 11.02, 5.49, 12, 24.03, 10.49),
            Block.box(11.5, 11, 5.5, 15.5, 24, 10.5),
